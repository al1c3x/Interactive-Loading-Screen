...
BaseRunner::BaseRunner() :
	...
	SpriteManager* spriteImage = new SpriteManager("SpriteSheet");
	GameObjectManager::getInstance()->addObject(spriteImage);
	
	LogoManager* assetManager = new LogoManager("AssetManager");
	GameObjectManager::getInstance()->addObject(assetManager);
